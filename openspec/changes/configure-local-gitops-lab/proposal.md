...
- Criar uma aplicação `payroll` mínima empacotada como Helm chart, implantada pelo Argo CD no ambiente de desenvolvimento e capaz de consumir um Secret sincronizado do OpenBao.
...
- Introduz manifests e valores Helm para K3D, External Secrets, bootstrap Argo CD e aplicação `payroll`.
- Exige um repositório Git inicializado e um remoto que o Argo CD consiga acessar.
